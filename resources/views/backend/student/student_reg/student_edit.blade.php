...
<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Education Section <span class="text-danger">*</span></h5>
		<div class="controls">
...
<div class="col-md-4">
	 ...
	 <select name="shift_id"  required="" class="form-control">
		...
		<div class="controls">
	 <input type="file" name="picture" class="form-control" id="picture" >  </div>
	 </div>
...
<div class="col-md-4">
 		...
 		<div class="form-group">
		<div class="controls">
	<img id="showPicture" src="{{ (!empty($editData['student']['picture']))? url('upload/student_pictures/'.$editData['student']['picture']):url('upload/no_image.jpg') }}" style="width: 100px; width: 100px; border: 1px solid #000000;"> 
