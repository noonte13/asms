...
<div class="form-group">
	 ...
	 <input type="file" name="picture" class="form-control" id="picture" >  </div>
 		 ...
 		 <div class="form-group">
		<div class="controls">
		<img id="showPicture" src="{{ (!empty($editData->picture))? url('upload/employee_pictures/'.$editData->picture):url('upload/no_image.jpg') }}" style="width: 100px; width: 100px; border: 1px solid #000000;"> 
