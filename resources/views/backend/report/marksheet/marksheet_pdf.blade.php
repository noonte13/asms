...
<div class="box bb-3 border-warning">
				  <div class="box-header">
					<h4 class="box-title">View <strong>Student MarkSheet </strong></h4>
				  </div>
   ...
   <img src="{{ url('upload/logo.png') }}" style="width: 120px; height: 120px;">			
        ...
        <div class="col-md-2 text-center">
  		...
  		<div class="col-md-4 text-center" style="float: left;">
  			<h4><strong>Advanced School Management System</strong></h4>
  			<h6><strong>Galolhu, Male', Maldives</strong></h6>
  			<h5><strong><u><i>Student Academic Transcript</i></u></strong></h5>
...
@endphp
<tr>
  <td width="50%"><strong>Average GP</strong></td>
  <td width="50%"> 
    @if($count_fail > 0)
    0.00
    @else
...
<tr>
  <td width="50%"><strong>Final Grade </strong></td>
  <td width="50%"> 
    @if($count_fail > 0)
    F
    @else
...
<div class="row"> <!--  6th row start -->
  <div class="col-md-4">
    ...
    <div class="text-center">Teacher / Lecturer</div>
  </div>

    <div class="col-md-4">
  <hr style="border: solid 1px; widows: 60%; color: #ffffff; margin-bottom: -3px;">
    <div class="text-center">Parent / Guardian </div>
  </div>

    <div class="col-md-4">
 <hr style="border: solid 1px; widows: 60%; color: #ffffff; margin-bottom: -3px;">
    <div class="text-center">Principal / HOD</div>
  </div>
