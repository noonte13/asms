 ...
 <option value="Female" {{ ($editData->gender == "Female" ? "selected": "") }} >Female</option>
	...
	<div class="form-group">
	 ...
	 <input type="file" name="picture" class="form-control" id="picture" >  </div>
	 	...
	 	<div class="form-group">
		<div class="controls">
	<img id="showPicture" src="{{ (!empty($user->picture))? url('upload/profile_pictures/'.$user->picture):url('upload/no_image.jpg') }}" style="width: 125px; width: 125px; border: 1px solid #000000;"> 
