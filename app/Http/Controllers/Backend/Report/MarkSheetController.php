...
class MarkSheetController extends Controller
{
    ...
    $count_fail = StudentMarks::where('year_id',$year_id)->where('class_id',$class_id)->where('exam_type_id',$exam_type_id)->where('id_no',$id_no)->where('marks','<','40')->get()->count();
    ...
    return view('backend.report.marksheet.marksheet_pdf',compact('allMarks','allGrades','count_fail'));
    	...
    	$notification = array(
    		'message' => 'Sorry, The Data Does Not Match',
    		'alert-type' => 'error'
    	);
